...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); //require('./toastr');


window.toastr = __webpack_require__(/*! ./toastr */ "./resources/js/toastr.js");
window.Vue = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.common.js"); //require('./axios');
...
__webpack_require__(/*! ./appCategory */ "./resources/js/appCategory.js");

__webpack_require__(/*! ./appBrands */ "./resources/js/appBrands.js");

__webpack_require__(/*! ./appUsers */ "./resources/js/appUsers.js");

__webpack_require__(/*! ./appCustomers */ "./resources/js/appCustomers.js");

__webpack_require__(/*! ./appAttributes */ "./resources/js/appAttributes.js");

__webpack_require__(/*! ./appTerms */ "./resources/js/appTerms.js");

__webpack_require__(/*! ./appProducts */ "./resources/js/appProducts.js");

__webpack_require__(/*! ./appOrders */ "./resources/js/appOrders.js");

/***/ }),

/***/ "./resources/js/appAttributes.js":
/*!***************************************!*\
  !*** ./resources/js/appAttributes.js ***!
  \***************************************/
/*! no static exports found */
...
new Vue({
  el: '#appAttributes',
  created: function created() {
    this.getAttributes(this.pagination.current_page); //this.eliminarMarca();
  },
  data: {
  ...
  methods: {
    getAttributes: function getAttributes(page) {
      ...
      axios.get(url).then(function (response) {
        ...
        _this.attributes = response.data.data.data, _this.pagination = response.data.pagination; //this.$set('attributes', response.data.data.data);
      });
    },
    createAttribute: function createAttribute() {
      ...
      axios.post(url, {
        ...
        _this2.getAttributes(); //this.changePage(this.pagination.current_page);
    ...
    editAttribute: function editAttribute(attribute) {
      ...
      axios.get(url).then(function (response) {
        ...
        _this3.fillAttribute.id = response.data.id;
        _this3.fillAttribute.attribute = response.data.attribute;
        $('#edit').modal('show');
      });
    },
    updateAttribute: function updateAttribute(attribute) {
      ...
      axios.put(url, this.fillAttribute).then(function (response) {
        console.log(response.data);

        _this4.getAttributes();

        _this4.fillAttribute = {
          'id': '',
          'attribute': ''
        }, _this4.errors = [];
        $('#edit').modal('hide');
...
new Vue({
  el: '#form-brand',
  created: function created() {
    this.getBrand(); //this.eliminarMarca();
  },
  data: {
    errors: [],
    brand: '',
  ...
  methods: {
    getBrand: function getBrand() {
      ...
      if (brands == "") {
        ...
        this.deshabilitar_boton = 1; //var erro = this.errors.push('El campo marca esta vacio');
        //console.log(erro);
      } else {
        console.log("marca es " + brands);
        var url = 'brands/registers/' + brands;
        axios.get(url).then(function (response) {
          if (response.data > 0) {
            toastr.success('La marca: ' + brands + ' existe'); //$('#brand').val('').focus();

            _this.deshabilitar_boton = 1;
          } else {
            _this.deshabilitar_boton = 0; //console.log('Se registro la marca: '+brands+' con exito.!');
          }
        });
      }
    },
    prueba: function prueba() {
      ...
      var input = $("#brand").val();
      var url = 'brands/registers/' + input;
      axios.get(url).then(function (response) {
        if (response.data > 0) {
...
new Vue({
  ...
  methods: {
    ...
    editBrand: function editBrand(brand) {
      ...
      axios.get(url).then(function (response) {
        _this3.fillBrand.id = response.data.id;
        _this3.fillBrand.brand = response.data.brand;
        $('#edit').modal('show');
      });
    },
    updateBrand: function updateBrand(brand) {
      ...
      var url = 'brand/' + brand; //axios.put()

      axios.post(url, this.fillBrand).then(function (response) {
        _this4.fillBrand = {
          'id': '',
          'brand': ''
        }; //this.errror = [];
  ...
  methods: {
    ...
    editCategory: function editCategory(category) {
      ...
      axios.get(url).then(function (response) {
        console.log(response.data);
        _this2.errors = '';
        _this2.fillCategory.id = response.data.id;
        _this2.fillCategory.category = response.data.category;
        _this2.fillCategory.slug = response.data.slug;
        _this2.fillCategory.description = response.data.description;
        $('#edit').modal('show');
      });
    },
    updateCategory: function updateCategory(category) {
      ...
      axios.put(url, this.fillCategory).then(function (response) {
        $('#edit').modal('hide'); //this.categories();
...
new Vue({
  ...
  methods: {
    ...
    editCustomer: function editCustomer(customer) {
      ...
      var url = 'customers/' + customer + '/edit';
      axios.get(url).then(function (response) {
        _this2.fillCustomer.id = response.data.id;
        _this2.fillCustomer.first_name = response.data.first_name;
        _this2.fillCustomer.last_name = response.data.last_name;
        _this2.fillCustomer.dni = response.data.dni;
        _this2.fillCustomer.phone = response.data.phone;
        _this2.fillCustomer.email = response.data.email;
    ...
    updateCustomer: function updateCustomer(customer) {
      ...
      var url = 'customers/' + customer; //axios.put()

      axios.put(url, this.fillCustomer).then(function (response) {
        //console.log(response.data);
        _this3.getCustomers();
...
$(document).ready(function () {
  ...
  $('#selectProduct').on('change', function () {
    var val_product = $(this).val(); //console.log(val_product);

    var separador = "_";
    product = val_product.split(separador); //Asigno el codigo y nombre del producto al input product

    $('#product').val(product[3] + ' ' + product[4]); //Asigno el stock del producto al input stock

    $('#stock').val(product[2]); //Asigno el precio del producto al input buy

    $('#buy').val(product[1]); //campo oculto de id del producto

    $('#product_id').val(product[0]); //campo oculto de sku

    $('#sku').val(product[3]); //campo oculto de producto
  ...
  count = 0; //total del pedido

  total = 0; //sub = 0;
  //subtotal del pedido

  subTotal = []; //oculto el boton de registrar

  $('#guardar').hide();

  function add() {
    //variable para el sku
    sku = $('#sku').val(); //variable para el producto

    prod = $('#prod').val(); //variable para la cantidad

    quantity = $('#quantity').val(); //variable para el precio

    buy = $('#buy').val(); //variable para el stock

    stock = $('#stock').val(); //variable con el id del producto
...
new Vue({
  ...
  methods: {
    deleteOrder: function deleteOrder(order) {
      ...
      if (confirm('Esta seguro que desea anular este pedido?')) axios["delete"](url).then(function (response) {
    ...
    updateStock: function updateStock(product) {}
  }
});

/***/ }),

/***/ "./resources/js/appProducts.js":
/*!*************************************!*\
  !*** ./resources/js/appProducts.js ***!
  \*************************************/
/*! no static exports found */
  ...
  methods: {
    ...
    openModal: function openModal(product) {
      ...
      axios.get(url).then(function (response) {
        console.log(response.data);
        _this.errors;
        _this.fillProduct.id = response.data.id;
        _this.fillProduct.sku = response.data.sku;
        _this.fillProduct.name = response.data.name;
    ...
    updateStock: function updateStock(product) {
      ...
      axios.post(url, this.fillProduct).then(function (response) {
        console.log(response.data);
        _this2.fillProduct = {
          'id': '',
          'name': '',
  ...
  methods: {
    ...
    editTerm: function editTerm(id) {
      ...
      axios.get(url).then(function (response) {
        ...
        _this2.fillTerm.id = response.data.id;
        _this2.fillTerm.attribute_id = response.data.attribute_id;
        _this2.fillTerm.name = response.data.name;
        _this2.fillTerm.slug = response.data.slug;
        _this2.fillTerm.description = response.data.description;
        $('#edit').modal('show');
      });
    },
    updateTerm: function updateTerm(id) {
      var _this3 = this;

      var url = 'terms/' + id;
      axios.put(url, this.fillTerm).then(function (response) {
        $('#edit').modal('hide'); //this.categories();
...
new Vue({
  el: '#appUsers',
  created: function created() {
    this.getUsers(this.pagination.current_page); //this.eliminarMarca();
  },
  data: {
    errors: [],
  ...
  methods: {
    ...
    editUser: function editUser(user) {
      ...
      axios.get(url).then(function (response) {
        _this2.fillUser.id = response.data.id;
        _this2.fillUser.name = response.data.name;
        _this2.fillUser.email = response.data.email;
        _this2.fillUser.password = response.data.password;
        $('#edit').modal('show');
      });
    },
    updateUser: function updateUser(user) {
      ...
      var url = 'users/' + user;
      axios.put(url, this.fillUser).then(function (response) {
        _this3.getUsers();
...
module.exports = __webpack_require__(/*! /var/www/html/importaRomanoBack/resources/js/app.js */"./resources/js/app.js");
